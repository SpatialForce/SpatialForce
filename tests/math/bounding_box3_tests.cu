...
CUDA_TEST(BoundingBox3, Constructors) {
    {
        BoundingBox3D box;
...
CUDA_TEST(BoundingBox3, BasicGetters) {
    BoundingBox3D box(Vector3D(-2.0, 3.0, 5.0), Vector3D(4.0, -2.0, 1.0));
...
CUDA_TEST(BoundingBox3, Overlaps) {
...
CUDA_TEST(BoundingBox3, Contains) {
...
CUDA_TEST(BoundingBox3, Intersects) {
    BoundingBox3D box(Vector3D(-2.0, -2.0, 1.0), Vector3D(4.0, 3.0, 5.0));
...
CUDA_TEST(BoundingBox3, ClosestIntersection) {
    ...
    EXPECT_NEAR(Vector3D(2, 2, 0).length(), intersection1.tNear, 1.0e-10);
    EXPECT_NEAR(Vector3D(3, 3, 0).length(), intersection1.tFar, 1.0e-10);
...
CUDA_TEST(BoundingBox3, MidPoint) {
    BoundingBox3D box(Vector3D(-2.0, -2.0, 1.0), Vector3D(4.0, 3.0, 5.0));
...
CUDA_TEST(BoundingBox3, DiagonalLength) {
    BoundingBox3D box(Vector3D(-2.0, -2.0, 1.0), Vector3D(4.0, 3.0, 5.0));
...
CUDA_TEST(BoundingBox3, DiagonalLengthSquared) {
    BoundingBox3D box(Vector3D(-2.0, -2.0, 1.0), Vector3D(4.0, 3.0, 5.0));
...
CUDA_TEST(BoundingBox3D, IsEmpty) {
    BoundingBox3D box(Vector3D(-2.0, -2.0, 1.0), Vector3D(4.0, 3.0, 5.0));
