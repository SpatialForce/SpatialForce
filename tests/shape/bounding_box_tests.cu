...
CUDA_TEST(BoundingBox, Constructors) {
    {
...
CUDA_TEST(BoundingBox, Overlaps) {
...
CUDA_TEST(BoundingBox, Contains) {
...
CUDA_TEST(BoundingBox, MidPoint) {
    BoundingBox<double, 2> box({-2.0, -2.0}, {4.0, 3.0});
...
CUDA_TEST(BoundingBox, DiagonalLength) {
    BoundingBox<double, 2> box({-2.0, -2.0}, {4.0, 3.0});
...
CUDA_TEST(BoundingBox, DiagonalLengthSquared) {
    BoundingBox<double, 2> box({-2.0, -2.0}, {4.0, 3.0});
